...
COPY brands (id, name, specialty) FROM stdin;
\.
...
SELECT pg_catalog.setval('brands_id_seq', 126, true);
...
SELECT pg_catalog.setval('stores_brands_id_seq', 68, true);
...
SELECT pg_catalog.setval('stores_id_seq', 223, true);
